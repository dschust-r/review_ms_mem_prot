...
Native mass spectrometry enables the analysis of intact proteins and their interactions while aiming to preserve native and functional structures. 
Unlike other MS techniques, native MS does not require denaturing conditions, thereby preserving non-covalent interactions, making it valuable for the study of membrane proteins and their interactions. 

Lipids are modulators of membrane protein structure and function, and native MS can be a helpful tool to study their roles. 
Zhang et al. found that the nucleotide-binding selectivity of the ATP-binding cassette transporter MsbA can be modulated through binding of an LPS-precursor-lipid [@DOI: 10.1038/s41467-024-50350-9]. 
Zhu et al. combined lipidomics with native MS to determine the lipid preferences of the K2P channel [@DOI: 10.1039/D3SC01482G], while another study used alanine scanning and molecular dynamics simulations to reveal key residues involved in AqpZ’s high-specificity binding to cardiolipin [@DOI: 10.1021/acs.biochem.4c00717]. 
Chen et al. applied native MS to vesicles formed from native rod outer segment disc membranes, showing that rho conversion to opsin is significantly slower in membranes than in detergent, emphasizing the role of lipid context in receptor signaling [@DOI:10.1038/s41586-022-04547-x]. 
This approach could be directly relevant for the study of drug mechanisms of action in native lipid environments. 

Native MS of membrane proteins is technically challenging. 
Efficient desolvation and ejection from detergent micelles is critical for accurate mass measurement, and the choice of detergent affects protein integrity and lipid retention [@DOI:10.1021/acs.analchem.4c03312]. 
Harsh activation often causes protein unfolding or subunit loss, but charge-reducing spermine-derived detergents have been developed to improve signal quality and reduce the required activation energy for micelle ejection [@DOI:10.1038/s41467-023-41429-w]. 
Alternatively, proteoliposomes have been shown to efficiently encapsulate soluble and membrane-associated proteins while retaining the attached lipids [@DOI: 10.1039/D3SC04938H].

A further technical limitation is the need to avoid high salt buffers which could cause instrument contamination. 
Agasid et al. [@DOI: 10.1021/jacs.0c11837] showed that decreasing electrospray emitter diameters to 100 nm (instead of the typical 10 to 100 μm) allows the use of high salt concentrations. 
In doing so, they find that GPCR ligand binding is influenced by the buffer composition. 
Enabling the study of membrane proteins in high salt buffer is beneficial for further ligand binding studies of receptors, transporters, or ion channels. 

Additionally, denaturing top-down proteomics methods are increasingly being applied to the study of membrane proteins. 
Wang et al. combined size exclusion chromatography with capillary zone electrophoresis (CZE) and top-down MS to identify 276 integral membrane protein proteoforms from mouse brain tissue [@DOI:10.1021/acs.analchem.3c02346]. 
In a separate study, Ives et al. used CZE-MS to profile proteoforms of the GPCRs β2AR and mGluR2, identifying nine distinct β2AR proteoforms with various phosphorylation states [@DOI:10.1021/acs.analchem.4c06994]. 
These findings demonstrate the potential of CZE-top-down-MS for characterizing membrane protein proteoforms, offering valuable insights for the development of selective modulators.
